...
class Face_Recognition_System:
    def __init__(self, root):
        ...
        b1.place(x=200, y=100, width=220, height=100)

        b3 = tk.Button(img_l, text="Attendence",
                       font=("times new roman", 26, "bold"),
                       bg="darkblue", fg="white", cursor="hand2")
        b3.place(x=500, y=100, width=220, height=100)

        b5 = tk.Button(img_l, text="Train",
                       font=("times new roman", 26, "bold"),
                       bg="darkblue", fg="white", cursor="hand2")
        b5.place(x=800, y=100, width=220, height=100)

        b7 = tk.Button(img_l, text="Developer",
                       font=("times new roman", 26, "bold"),
                       bg="darkblue", fg="white", cursor="hand2")
        b7.place(x=1100, y=100, width=220, height=100)

        # ===== Second Row =====
        b2 = tk.Button(img_l, text="Detect Face",
                       font=("times new roman", 26, "bold"),
                       bg="darkblue", fg="white", cursor="hand2")
        b2.place(x=200, y=300, width=220, height=100)

        b4 = tk.Button(img_l, text="Help",
                       font=("times new roman", 26, "bold"),
                       bg="darkblue", fg="white", cursor="hand2")
        b4.place(x=500, y=300, width=220, height=100)

        b6 = tk.Button(img_l, text="Photos",
                       font=("times new roman", 26, "bold"),
                       bg="darkblue", fg="white", cursor="hand2")
        b6.place(x=800, y=300, width=220, height=100)

        b8 = tk.Button(img_l, text="Exit",
                       font=("times new roman", 26, "bold"),
                       bg="darkblue", fg="white", cursor="hand2")
        b8.place(x=1100, y=300, width=220, height=100)
